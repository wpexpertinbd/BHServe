...
<style>
  ...
  .footer { margin-top:22px; font-size:13px; color:#999; }
  .footer a { color:#20a53a; text-decoration:none; }
</style>
</head>
<body>
  <div class='container'>
    ...
    <div class='footer'>Powered by <strong>BHServe</strong> &middot; <a href='https://www.biswashost.com' target='_blank' rel='noopener'>biswashost.com</a></div>
  </div>
</body>
</html>
";
